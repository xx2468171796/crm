    ...
    <div class="d-flex">
        ...
        <div class="finance-sidebar d-none d-lg-block" id="financeSidebar">
            <nav class="nav flex-column py-3">
                ...
                <a class="nav-link <?= $currentPage === 'finance_fee_dashboard' ? 'active' : '' ?>" href="index.php?page=finance_fee_dashboard" data-title="手续费收款台">
                    <i class="bi bi-calculator"></i><span class="nav-text">手续费收款台</span>
                </a>
                <a class="nav-link <?= $currentPage === 'finance_cashier' ? 'active' : '' ?>" href="index.php?page=finance_cashier" data-title="收款台" style="display:none;">
                    <i class="bi bi-cash-stack"></i><span class="nav-text">收款工作台</span>
                </a>
