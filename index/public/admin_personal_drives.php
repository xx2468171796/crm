...
// 验证管理员权限
$user = current_user();
if (!$user || !in_array($user['role'], ['admin', 'manager', '主管'])) {
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2 sidebar py-4">
                <h5 class="px-3 mb-4"><i class="bi bi-hdd-stack me-2"></i>网盘管理</h5>
                <nav class="nav flex-column">
                    <a class="nav-link" href="/admin/"><i class="bi bi-arrow-left me-2"></i>返回后台</a>
                </nav>
            </div>
            
            <div class="col-md-10 main-content">
                <h4 class="mb-4">个人网盘管理</h4>
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-people me-2"></i>用户网盘列表</span>
                            </div>
                            <div class="card-body" style="max-height: 600px; overflow-y: auto;">
                                ...
                                <div class="drive-card <?php echo $selectedDriveId == $drive['id'] ? 'active' : ''; ?>" 
                                     onclick="location.href='?drive_id=<?php echo $drive['id']; ?>'">
