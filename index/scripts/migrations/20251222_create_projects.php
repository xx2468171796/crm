...
try {
    ...
    ");
    echo "✓ 创建 projects 表成功\n";
    
    // 2. 创建 project_tech_assignments 表
    echo "创建 project_tech_assignments 表...\n";
    $pdo->exec("
    ...
    ");
    echo "✓ 创建 project_tech_assignments 表成功\n";
    
    // 3. 创建 project_status_log 表
    echo "创建 project_status_log 表...\n";
    $pdo->exec("
    ...
    ");
    echo "✓ 创建 project_status_log 表成功\n";
    
    // 4. 创建 timeline_events 表（统一时间线审计）
    echo "创建 timeline_events 表...\n";
    $pdo->exec("
    ...
    ");
    echo "✓ 创建 timeline_events 表成功\n";
    
    echo "\n迁移完成！\n";
    echo "提示：请运行数据迁移脚本为现有客户创建默认项目\n";
